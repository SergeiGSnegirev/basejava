...
public class MainTestArrayStorage {
    ...
    public static void main(String[] args) {
        Resume r1 = new Resume("uuid1", "Sam Cooke");
        Resume r2 = new Resume("uuid2", "Ray Charles");
        Resume r3 = new Resume("uuid3", "James Brown");
        Resume r4 = new Resume("uuid4", "Otis Redding");
        ...
        Resume r2n = new Resume("uuid2", "Paul Anka");
        System.out.println("\nUpdating r2...");
        ARRAY_STORAGE.update(r2n);

        Resume rd = new Resume("dummy", "John Doe");
        System.out.println("\nUpdating dummy...");
